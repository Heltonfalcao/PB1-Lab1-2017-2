...
using WebAppAutomovel.Models;

namespace WebAppAutomovel.Controllers
{
    public class AutomovelController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AutomovelId,Carro,Caminhao,Motocicleta,Descricao,Marca,DataDeCadastro")] Automovel automovel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AutomovelId,Carro,Caminhao,Motocicleta,Descricao,Marca,DataDeCadastro")] Automovel automovel)
        {
            if (ModelState.IsValid)
            {
